...
#ifndef __CURE_DEFS_H__
#define __CURE_DEFS_H__
 ...
 *
 * BUFSIZ is defined in the standard C library. This macro
 * is validated in non-standard C environments rather as a
 * moderate value.
 */
#ifndef BUFSIZ
#define BUFSIZ 512
...
#endif
typedef int                int32_t;     /*!< 32-bit unsigned integer */
