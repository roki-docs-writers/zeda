...
#ifndef __CURE_MISC_H__
#define __CURE_MISC_H__
 ...
 */
/*! \cond */
extern bool __cure_echo;
/*! \endcond */
#define zEchoOn()  ( __cure_echo = true )
#define zEchoOff() ( __cure_echo = false )
 ...
 */
#define ZSYSERROR()         perror( __FUNCTION__ )
#define ZRUNERROR(msg,...) ( __cure_echo ? eprintf( "run-time error: " msg "(%s).\n", ##__VA_ARGS__, __FUNCTION__ ) : 0 )
#define ZRUNWARN(msg,...)  ( __cure_echo ? eprintf( "warning: " msg "(%s).\n", ##__VA_ARGS__, __FUNCTION__ ) : 0 )

#define ZECHO(m)      eprintf( "%s\n", (m) )
 ...
 *
 * itoa_fill() converts a given integer \a val to a
 * string with its blank filled by \a pat.
 * \a size is the length of the string. If the digit
 * of \a val is more than \a size, \a size is ignored.
 *
 *  Examples:
 *
